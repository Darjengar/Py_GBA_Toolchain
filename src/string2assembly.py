#HunterxPokemon 2017
import sys, argparse, time, os, pathlib
#
...
# C Version
if args.c:
    print('OUTFILE C SOURCE: %s', args.out_file)
    #create output file
    ...
    print(base)
    header_file = base + '.h'
    print('OUTFILE HEADER: %s', header_file)
